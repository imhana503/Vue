...
//let selectedExercise = null; UI가 자바스크립트의 변경사항을 반영하기 위해 다시 렌더링해야 한다는 것을 알 수 있으려면, 상태(stateful) 변수가 필요함
...
<template>
  <Portal hello="word" :handleCloseModal="handleCloseModal" v-if="selectedExercise">
